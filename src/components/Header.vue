...
<template>
    <header class="header border-b border-solid border-b-gray-200 py-5 shadow">
        <div class="flex justify-between items-center container mx-auto">
            <router-link :to="{ name: 'home' }" class="flex items-center gap-x-2.5">
                <svg
                    width="50px"
                    height="50px"
                    viewBox="0 0 64 64"
                ...
                <span class="text-3xl font-bold">Today News</span>
            </router-link>
            <div class="flex items-center gap-x-12">
                <ul class="flex gap-x-8 text-md">
                    <li>
