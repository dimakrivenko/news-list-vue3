...
<template>
    <div class="ui-input">
        ...
        <input
            ...
            @input="handleInput"
            v-bind="attrs"
            class="block w-full rounded-md bg-white px-4 py-2 text-base text-gray-900 border border-gray-200 placeholder:text-gray-400 focus:border-indigo-600 transition ease-in-out duration-200"
            :class="{
                'ui-input-value': true,
                'is-invalid': !!error,
            }" />
